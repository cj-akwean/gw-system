  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          "fixed left-1/2 top-1/2 z-50 grid w-full max-w-sm -translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl border border-border bg-card p-6 text-center shadow-xl",
...
function AlertDialogAction({
  ...
  return (
    <AlertDialogPrimitive.Action
      ...
      className={cn(buttonVariants(), "h-10 w-full px-6 text-xs sm:w-auto", className)}
      {...props}
    />
  );
}
  ...
  return (
    <AlertDialogPrimitive.Cancel
      ...
      className={cn(
        ...
        "h-10 w-full px-6 text-xs sm:w-auto",
        className
      )}
      {...props}
    />
