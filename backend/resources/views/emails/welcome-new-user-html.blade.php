...
<head>
    ...
    <title>Welcome to Guinobatan Waterworks</title>
    <style>
...
<body style="margin: 0; padding: 0; width: 100%; min-width: 100%; background-color: #eef4f9; font-family: Arial, Helvetica, sans-serif;">
    ...
    <div class="gw-preheader">
        Welcome to Guinobatan Waterworks
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" class="gw-card" style="width: 100%; background-color: #ffffff; border: 1px solid #dbe4ee; border-radius: 12px;">
                                <tr>
                                    <td class="gw-card-pad" style="padding: 32px;">
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                                            <tr>
                                                <td style="padding-bottom: 4px; font-size: 22px; line-height: 28px; color: #12294a; font-weight: bold;">Welcome to Guinobatan Waterworks!</td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 14px; line-height: 22px; color: #5f7186;">
                                                    Hi <strong style="color: #12294a;">{{ $greeting }}</strong>, your account for <strong style="color: #12294a;">{{ $user->email }}</strong> is ready.
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                                            <tr>
                                                <td style="font-size: 13px; line-height: 20px; color: #5f7186;">
                                                    From your account you can view your water usage, manage your service connection details, and pay your bills online.
                                                    If you have any questions, we're here to help — just reach out using the contact details below.
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
