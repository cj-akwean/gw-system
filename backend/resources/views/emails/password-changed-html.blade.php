                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" class="gw-card" style="width: 100%; background-color: #ffffff; border: 1px solid #dbe4ee; border-radius: 12px;">
                                <tr>
                                    <td class="gw-card-pad" style="padding: 32px;">
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                                            <tr>
                                                <td style="padding-bottom: 4px; font-size: 22px; line-height: 28px; color: #12294a; font-weight: bold;">Your password has been changed</td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 14px; line-height: 22px; color: #5f7186;">
                                                    The password for <strong style="color: #12294a;">{{ $user->email }}</strong> was changed on <strong style="color: #12294a;">{{ now()->format('M d, Y') }}</strong>.
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                                            <tr>
                                                <td style="font-size: 13px; line-height: 20px; color: #5f7186;">
                                                    If you made this change, no further action is needed. If you did <strong style="color: #12294a;">not</strong> change your password, contact us immediately — your account may have been compromised.
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
